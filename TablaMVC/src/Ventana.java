...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(0x61DBCF));
        lblId = new JLabel("id");
        ...
        panel2.setBackground(new Color(0x20C024));
        info = new ArrayList<>();
        info.add(new VideoJuego(1,"Call of Duty","Accion",20.5,"Android y IOS","Activision"));
